        ...
        <div className="relative p-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className={`text-base font-medium ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>Transport Provider Setup</h1>
                <p className={`text-xs ${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}`}>Configure transport providers for booking services</p>
              </div>
            </div>
          </div>
        </div>
